...
function Card({ data }: CardProps) {
    return (
        <>
            <button className="group hover:shadow-3d-hover  shadow-3d hover:bg-primary  transition-all  duration-500  ease-in-out  p-4 lg:p-8 md:p-8  sm:p-4 flex  flex-row lg:flex-col  md:flex-col  sm:flex-col    items-center  gap-0 lg:gap-2  md:gap-2  sm:gap-0  bg-white  border-2  border-black rounded-3xl  ">
