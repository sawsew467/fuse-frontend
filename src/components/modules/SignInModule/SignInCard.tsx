...
export function SignInCard({
  ...
  return (
    <div
      className={cn(
        "shadow-3d hover:shadow-3d-hover min-h-[400px] w-full max-w-[500px] flex-1 rounded-3xl border-2 border-black bg-white px-4 py-8 transition-all duration-500 sm:px-6 sm:py-12 md:px-8 md:py-16 lg:px-10 lg:py-12",
        "absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform",
        "z-10",
        mode === "SIGNUP" ? "hidden" : "block",
      )}
    >
      <Logo />
